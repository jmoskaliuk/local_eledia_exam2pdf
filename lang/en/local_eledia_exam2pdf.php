...
$string['report_section_intro'] = 'Generated PDF certificates for this quiz. Click an icon to download a single certificate, or use the button below to download all certificates as a ZIP archive.';
...
$string['setting_pdfgeneration_desc'] = 'When to generate the PDF certificate. "On submission" creates it automatically when a quiz attempt is submitted. "On demand" only creates it when a teacher clicks the download button.';
$string['setting_pdfscope'] = 'PDF scope';
$string['setting_pdfscope_desc'] = 'Which attempts are eligible for PDF generation. "Passed only" requires the attempt to meet the pass grade. "All finished" generates a PDF for every completed attempt.';
...
$string['setting_studentdownload_desc'] = 'If enabled, students can download their own PDF certificate from the quiz review page. If disabled, only teachers can access PDFs via the report page.';
